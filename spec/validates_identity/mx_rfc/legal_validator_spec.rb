...
RSpec.describe ValidatesIdentity::MxRfc::LegalValidator do
  it 'accepts RAA921127RI6' do
    expect(described_class.new('RAA921127RI6')).to be_valid
  end

  it 'accepts DST850311SA3' do
    expect(described_class.new('DST850311SA3')).to be_valid
  end

  it 'accepts IMS120607120' do
    expect(described_class.new('IMS120607120')).to be_valid
  end

  it 'rejects RAAA921127RI6' do
    expect(described_class.new('RAAA921127RI6')).not_to be_valid
  end

  it 'rejects DSRT850311SA3' do
    expect(described_class.new('DSRT850311SA3')).not_to be_valid
  end

  it 'rejects IMST120607120' do
    expect(described_class.new('IMST120607120')).not_to be_valid
  end
